...
def Delta_camb(k, h=h, omb=omb, om0=om, ns=ns, sig8=sigma8, omk=0.0, cosmomc_theta=None,
...
def sigma_camb_R(R, sig8=sigma8, h=h, omb=omb, om0=om, ol0 = oml, ns=ns, kmax=30,  prec=1000, window=W_th):
    """
...
def sigma_camb(x, sig8=sigma8, h=h, kmax=30, window='TopHat', xin='M', prec=1000, om0=om, ol0=oml, omb=omb):
    """
    :param M: Mass, could be an nd.array
    :param k: wavenumbers for calculating the integral nd array
    :param pk: power spectrum values nd array same size as k
